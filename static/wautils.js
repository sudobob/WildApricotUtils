...
$(document)
  .ready(() => {
    ...
    $(document)
      .on('click', '.event_row_edit_btn', function() {
    ...
    $(document)
      .on('click', '#show_events_btn', function() {
        hide_maindiv()
          .then(() => {
            console.log('1');
            $('#maindiv').html('');
    ...
    */
      ...
      return new Promise(function(resolve, reject) {
        ...
        if (!got_one) {
          ...
          $.ajax({
            ...
            data: $.param({
              'endpoint': 'accounts/$accountid/EventRegistrationTypes/' + id
            }),
            success: (j) => {
    ...
    function get_membershiplevels() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        $.ajax({
          ...
          // string '$accountid' will get replaced with real account id on server
          data: $.param({
            'endpoint': 'accounts/$accountid/membershiplevels'
          }),
          success: (j) => {
    ...
    function get_signoffs() {
      return new Promise(function(resolve, reject) {
        ...
        $.ajax({
          ...
          // string '$accountid' will get replaced with real account id on server
          data: $.param({
            'endpoint': '/accounts/$accountid/contactfields'
          }),
          success: (j) => {
            extract_contentfield(j, 'NL Signoffs and Categories');
            resolve();
          },
          failure: (errMsg) => {
            alert("FAIL:" + errMsg);
    ...
    function get_contacts() {
      ...
      */
      ...
      ep = $.param({
        'endpoint': 'accounts/$accountid/contacts/?' + fep
      });
    ...
    function Xsignoffs_save() {
      ...
      //
      checked_divs = $('.signoff_item_div > input:checked')
        .parent();
    ...
    function get_events() {
      ...
      ep = $.param({
        'endpoint': 'accounts/$accountid/events/?' + fep
      });
      return new Promise(function(resolve, reject) {
        u = '/api/v1/wa_get_any_endpoint',
          $.ajax({
    ...
    function fetch_contact_info(id) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        $.ajax({
          ...
          // string '$accountid' will get replaced with real account id on server
          data: $.param({
            'endpoint': 'accounts/$accountid/contacts/' + id
          }),
          success: (j) => {
    ...
    function get_event_registrations() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        ep = $.param({
          'endpoint': 'accounts/$accountid/eventregistrations?' + fep
        });
        u = '/api/v1/wa_get_any_endpoint',
          $.ajax({
            type: 'GET',
    ...
    function process_event_registrations() {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (event_info.error == 1) {
          ...
          $('#events_table')
            .bootstrapTable('hideColumn', 'Memo');
